...
2. Add Material stuff to the create-react-app code
   1. index.html
      ```
      <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&display=swap" />
      ```
   2. Delete App.css, index.css, logo.svg and their references in index.js
   3. Replace all the content of app.js with new code
