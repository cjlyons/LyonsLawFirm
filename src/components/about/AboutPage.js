  ...
  return (
    <Grid className={classes.grid} container spacing={0}>
      <Card className={classes.card} sx={{ display: "flex" }}>
        <CardContent>
          <Typography variant="h5">Erin Lyons</Typography>
        </CardContent>
        <CardContent>
          <Typography variant="body1">Erin Lyons bio.</Typography>
          <Typography variant="body1">More about Erin Lyons.</Typography>
          <Typography variant="body1">Deep dive into Erin Lyons.</Typography>
        </CardContent>
      </Card>
    </Grid>
  );
